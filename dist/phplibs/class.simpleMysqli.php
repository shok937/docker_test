...
class simpleMysqli extends simpleDB
{
    ...
    public function __construct($connectionSettingsArray)
    {
        ...
        $this->db_resource = mysqli_init();
        $this->db_resource->options(MYSQLI_OPT_SSL_VERIFY_SERVER_CERT, true);
        $this->db_resource->ssl_set(NULL, NULL, '/var/www/lk.agrad.ru/.mysql/root.crt', NULL, NULL);
        $this->db_resource->real_connect($server, $username, $password, $db, $port, NULL, MYSQLI_CLIENT_SSL);
